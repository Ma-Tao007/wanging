			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    <div class="panel-heading">
						<div class="row">
					    	<h1 class="col-md-5">成绩管理</h1>

							<button class="btn btn-default col-md-2" style="margin-top: 20px" onClick="location.href='grade?method=addPage'">
								添加学生成绩信息
				    ...
				    <table class="table table-bordered">
							...
							<c:forEach  items="${nlist}" var="item" varStatus="i" >
								<tr>
									...
									<td>${item.grade}</td>
									<td>
										<button class="btn btn-default btn-xs btn-info" onClick="location.href='grade?method=editPage&id=${item.id}'">修改</button>
...
<input hidden id="contextPath" value="${pageContext.request.contextPath}">
	...
	<script type="text/javascript">
        ...
        function confirmd(id) {
            var msg = "您真的确定要删除吗？！";
            if (confirm(msg)==true){
                location.href='grade?method=delete&id='+id;
            }else{
                return false;
            }
        }
